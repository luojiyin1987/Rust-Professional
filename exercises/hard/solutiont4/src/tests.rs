...
mod tests {
    ...
    // 基础测试
    ("2025-01-01", "1,3,1,364,28,1"), // 新年第一天，周三，距春节28天
    ...
    // 重要日期测试
    ("2025-02-28", "9,5,59,306,354,3"), // 2月的最后一天（非闰年），距2026年春节354天
    ("2025-04-01", "14,2,91,274,322,1"), // 4月1日，周二，距2026年春节322天
    ...
    fn test_calc_time() {
        ...
        for (input, expected) in TEST_CASES {
            ...
            if result != *expected {
            println!("Input: {}, Result: {}, Expected: {}, Duration: {:?}", input, result, expected, duration);
            }
            // 时间超0.2s，判定不合格
